...
public class Sql2oDepartmentNewsDaoTest {
    ...
    public void addingReviewSetsId() throws Exception {
       ...
       DepartmentNews testDepartmentNews = new DepartmentNews("Greetings", "Jeanine", "Hello", 1,1);
  ...
  /*  @Test
    ...
    public DepartmentNews setupDepartmentNews() {
        DepartmentNews DepartmentNews = new DepartmentNews("Greetings", "Jeanine", "Hello", 1,1);
