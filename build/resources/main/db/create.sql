* CREATE DATABASE companynews;
 \c companynews
* CREATE TABLE departments (id serial PRIMARY KEY,name varchar, description varchar,size varchar);

* CREATE TABLE employees
(id serial PRIMARY KEY,name varchar, position varchar, role varchar,department_id int);
...
(id serial PRIMARY KEY,title varchar, writtenby varchar, content varchar,
createdat timestamp, employee_id int,department_id int);
